...
<div class="brightly-notice-dont-show-container">
	<button class="button-link brightly-dont-show-notice">
		<?php Translations::escHtmlE( 'dont_show_anymore' ); ?>
	</button>
</div>

<div class="brightly-admin-notice-spacer">
	<div class="brightly-admin-big-notice--container">
		<div class="content-holder">
			<div class="messages-area">
				<div class="title-holder">
					<h1><?php Translations::escHtmlE( 'would_you_like_to_install_front_page', brightly_theme()->getName() ); ?></h1>
					<p><?php Translations::escHtmlE( 'theme_description', brightly_theme()->getName() ); ?></p>
				</div>

				<ul>
					<li>
						<img src="<?php echo brightly_theme()->getListMarkerUrl(); ?>" alt="">
			...
			<div class="front-page-preview">
				<img src="<?php echo esc_url( brightly_theme()->getFrontPagePreview() ); ?>"/>
			</div>
		</div>
	</div>
</div>
