...
class Theme extends ThemeBase {
	...
	public function enqueueThemeInfoPageScripts() {
		...
		if ( $this->shouldDisplayAdminNotice() ) {
            ...
            <script>
				jQuery(function ($) {
					$(".brightly-admin-big-notice").show();
				});
            </script>
			<?php
	...
	public function addThemeNotice() {
		if ( $this->shouldDisplayAdminNotice() ) :
			?>
            <div class="notice notice-success is-dismissible brightly-admin-big-notice notice-large">
            ...
            <div>
                    ...
                    <div class="kubio-onboarding__wrapper__content">
                        <label>
                            ...
                            <div class="radio-card">
                                <div class="radio-card__radio-checked">
									<?php echo file_get_contents( brightly_theme()->getThemeResource( 'images/theme-base/check.svg' ) ); ?>
                                    <div class="radio-card__radio-checked__background"></div>
                                </div>
                                <div class="radio-card__image-container">
                                    <img src="<?php echo brightly_theme()->getThemeResource( 'images/theme-base/web-layout.png' ); ?>"
                        ...
                        <label>
                            ...
                            <div class="radio-card">
                                ...
                                <div class="radio-card__image-container">
                                    <img src="<?php echo brightly_theme()->getThemeResource( 'images/theme-base/blog-layout.png' ); ?>"
                ...
                <div class="kubio-onboarding__wrapper kubio-step-2">
                    ...
                    <div class="kubio-onboarding__wrapper__content">
                        ...
                        <ul>
                            <li>
								<?php echo file_get_contents( brightly_theme()->getThemeResource( 'images/theme-base/round-check.svg' ) ); ?>
