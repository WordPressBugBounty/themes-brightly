...
<div style="<?php $component->printPostFeaturedImage(); ?>" class="wp-block wp-block-kubio-hero  position-relative wp-block-kubio-hero__outer brightly-header__k__KFTMhA6WOVh-outer brightly-local-1096-outer d-flex h-section-global-spacing align-items-lg-center align-items-md-center align-items-center" data-kubio="kubio/hero" id="hero">
	<?php $component->printBackground(); ?><?php $component->printSeparator(); ?>
	<div class="position-relative wp-block-kubio-hero__inner brightly-header__k__KFTMhA6WOVh-inner brightly-local-1096-inner h-navigation-padding h-section-grid-container h-section-boxed-container">
