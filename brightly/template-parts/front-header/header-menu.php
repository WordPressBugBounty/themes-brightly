...
<div class="wp-block wp-block-kubio-dropdown-menu  position-relative wp-block-kubio-dropdown-menu__outer brightly-front-header__k__c6BbujDIAOYa-outer brightly-local-565-outer kubio-dropdown-menu h-ignore-global-body-typography <?php echo $component->printHeaderMenuClasses(); ?>" data-kubio="kubio/dropdown-menu" data-kubio-component="dropdown-menu" data-kubio-settings="[]">
  ...
  'wrapper_class' => 'wp-block wp-block-kubio-logo position-relative wp-block-kubio-logo__container  kubio-logo-direction-row brightly-front-header__k__afIZ7lcsba-container brightly-local--container',
  'logo_image_class' => 'position-relative wp-block-kubio-logo__image  kubio-logo-image  brightly-front-header__k__afIZ7lcsba-image brightly-local--image',
  'alt_logo_image_class' => 'position-relative wp-block-kubio-logo__alternateImage kubio-logo-image kubio-alternate-logo-image   brightly-front-header__k__afIZ7lcsba-alternateImage brightly-local--alternateImage',
  'logo_text_class' => 'position-relative wp-block-kubio-logo__text  brightly-front-header__k__afIZ7lcsba-text brightly-local--text',
)); ?>
										</div>
									</div>
								</div>
